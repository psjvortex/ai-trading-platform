//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_1_9_7_BT.mq5     |
...
input string TradeComment = "TP_Integrated 4_1_9_7_BT";      // Trade comment
...
input int         StopLossPips_Indices    = 800;             // SL Indices (pips) - 350 points (reasonable for NAS100/US30)
input int         TakeProfitPips_Indices  = 400;             // TP Indices (pips)
input int         StopLossPips_Crypto     = 3000;              // SL Crypto (pips) - $500 for BTCUSD ($10/pip)
input int         TakeProfitPips_Crypto   = 1000;              // TP Crypto (pips) - $250 for BTCUSD
input int         StopLossPips_Metal      = 3000;             // SL Metals (pips) - $8 for XAUUSD
input int         TakeProfitPips_Metal    = 1000;             // TP Metals (pips)
input bool        UseTrailingStop         = false;           // Enable trailing stop
input int         TrailingStopPips        = 30;              // Trailing stop (pips)

// === Entry System Selection ===
input group "📊 Entry Logic"
input INDICATOR_VERSION    IndicatorVersion           = INDICATOR_UNIVERSAL;  // Indicator version to use (UNIVERSAL recommended)
