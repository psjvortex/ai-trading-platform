...
input string JSONConfigFile = "EA_Config_v2_6.json";  // JSON config file (primary)
input bool UseJSONConfig = true;                      // Use JSON config (false = use manual inputs)
input int MagicNumber = 777888;                       // EA magic number
input string TradeComment = "TP_Auto_2.7";            // Trade comment
...
int OnInit()
{
   ...
   Print("");
   Print("✅ ALL SYSTEMS READY - v2.7 JSON-DRIVEN!");
   Print("═══════════════════════════════════════════════════════");
   Print("📋 Configuration:");
   Print("   EA Version: v2.7 (JSON-Driven Self-Learning)");
   ...
   Print("   CSV Files: v2.7 (JSON-Driven - Trades & Signals)");
   Print("═══════════════════════════════════════════════════════");
