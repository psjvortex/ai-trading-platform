//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_8.mq5     |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v4.1.8.8 - SLOPE ANALYSIS (QA APPROVED)                |
//+------------------------------------------------------------------+

#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "4.1.8.8"
#property description "v4.1.8.8 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.8.8_SLOPE"

input int MagicNumber = 4004188;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_8_8";      // Trade comment
