//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_1_9_9.mq5        |
...
#property description "v4.1.9.9 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.9.9_SLOPE"

input int MagicNumber = 4004199;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_9_9";      // Trade comment
