//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_2_0_3.mq5        |
...
#property description "v4.2.0.3 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.2.0.3_SLOPE"

input int MagicNumber = 4004203;                        // EA magic number
input string TradeComment = "TP_Integrated 4_2_0_3";      // Trade comment
