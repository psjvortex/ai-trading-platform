//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_2_0_4.mq5        |
...
#property description "v4.2.0.4 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.2.0.4_SLOPE"

input int MagicNumber = 4004204;                        // EA magic number
input string TradeComment = "TP_Integrated 4_2_0_4";      // Trade comment
