...
// #property description "v5.0.0.4 EA - MASTER RELEASE - Granular Buy/Sell Inputs"
...
input bool                 UseMAForEntry              = true;           // Use MA trend alignment for ENTRY signals
input bool                 UseMAForExit               = false;           // Use MA trend reversal for EXIT signals
input bool                 RequireMAWithPhysics       = true;           // Require MA + Physics combined (AND logic)
