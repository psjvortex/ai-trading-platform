//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_1_9_8.mq5        |
...
#property description "v4.1.9.8 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.9.8_SLOPE"

input int MagicNumber = 4004198;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_9_8";      // Trade comment
...
input int         StopLossPips_Forex      = 9;             // SL Forex (pips) - 90 points on 5-digit
input int         TakeProfitPips_Forex    = 3;             // TP Forex (pips) - 30 points
