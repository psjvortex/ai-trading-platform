//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_0.mq5     |
...
#property version   "4.180"
#property description "v4.180 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.180_SLOPE"

input int MagicNumber = 400418;                       // EA magic number
input string TradeComment = "TP_Integrated 4_180";      // Trade comment
