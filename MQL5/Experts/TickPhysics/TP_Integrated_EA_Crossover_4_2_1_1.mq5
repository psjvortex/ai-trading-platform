//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_2_1_1.mq5        |
...
// #property description "v4.2.1.1 EA with Complete Data Integrity + ConfluenceSlope + Spread + Entropy - ML-READY"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.2.1.1_COMPLETE"

input int MagicNumber = 4004211;                        // EA magic number
input string TradeComment = "TP_Integrated 4_2_1_1";      // Trade comment
...
input bool        UseAssetAdaptiveSLTP    = false;            // Enable asset-specific SL/TP defaults
