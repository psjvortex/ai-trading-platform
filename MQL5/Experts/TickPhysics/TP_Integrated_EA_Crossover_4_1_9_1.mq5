//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_9_1.mq5     |
...
#property description "v4.1.9.1 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.9.1_SLOPE"

input int MagicNumber = 4004191;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_9_1";      // Trade comment
...
input int         StopLossPips            = 900;        // Stop loss (pips) - REALISTIC DEFAULT
input int         TakeProfitPips          = 300;       // Take profit (pips) - 2:1 R:R
