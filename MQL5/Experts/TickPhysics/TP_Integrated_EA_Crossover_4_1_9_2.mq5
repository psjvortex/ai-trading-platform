//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_9_2.mq5     |
...
#property description "v4.1.9.2 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.9.2_SLOPE"

input int MagicNumber = 4004192;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_9_2";      // Trade comment
