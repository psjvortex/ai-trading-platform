//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_3.mq5     |
...
#define EA_VERSION "4.183_SLOPE"

input int MagicNumber = 4004183;                       // EA magic number
input string TradeComment = "TP_Integrated 4_183";      // Trade comment
...
input double               MinSpeedSlopeBuy           = 2.0;             // Min Speed slope for BUY (positive, units/bar)
input double               MinSpeedSlopeSell          = -2.0;            // Min Speed slope for SELL (negative, units/bar)
input bool                 UseAccelerationSlope       = true;           // Require Acceleration slope confirmation
input double               MinAccelerationSlopeBuy    = 5.0;             // Min Acceleration slope for BUY (positive, units/bar)
input double               MinAccelerationSlopeSell   = -5.0;            // Min Acceleration slope for SELL (negative, units/bar)
