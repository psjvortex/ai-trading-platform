//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_2.mq5     |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v4.180 - SLOPE ANALYSIS (QA APPROVED)                |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "4.182"
#property description "v4.182 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.182_SLOPE"

input int MagicNumber = 4004182;                       // EA magic number
input string TradeComment = "TP_Integrated 4_182";      // Trade comment
...
input int         StopLossPips            = 30000;        // Stop loss (pips) - REALISTIC DEFAULT
input int         TakeProfitPips          = 30000;       // Take profit (pips) - 2:1 R:R
...
input double               MinAccelerationBuy         = 80.0;           // Min acceleration for BUY (positive)
input double               MinAccelerationSell        = -80.0;          // Min acceleration for SELL (negative value)
input bool                 UseSpeedFilter             = true;           // Enable speed threshold
input double               MinSpeedBuy                = 55.0;            // Min speed for BUY (positive)
input double               MinSpeedSell               = -55.0;           // Min speed for SELL (negative value)
input bool                 UseMomentumFilter          = true;           // Enable momentum threshold
input double               MinMomentumBuy             = 30.0;            // Min momentum for BUY (positive)
input double               MinMomentumSell            = -30.0;           // Min momentum for SELL (negative value)
