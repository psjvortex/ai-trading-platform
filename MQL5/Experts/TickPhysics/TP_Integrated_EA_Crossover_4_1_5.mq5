//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_5.mq5       |
...
#property description "v4.15 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.15_SLOPE"

input int MagicNumber = 400415;                       // EA magic number
input string TradeComment = "TP_Integrated 4_15";      // Trade comment
...
void UpdateDashboard()
{
   ...
   // Update allFiltersPass to include new v4.2 filters
   allFiltersPass = BypassAllFilters || (!filtersEnabled) || (qualityPass && zonePass && accelPass && speedPass && momentumPass && physicsScorePass && confluencePass);
...
int OnInit()
{
   ...
   // Format: TP_Integrated_NAS100_M05_MTBacktest_v4.15_SLOPE_signals.csv
   // Note: EA_VERSION already includes build tag (e.g., "4.15_SLOPE"), so no additional buildTag needed
