//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_2.mq5       |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v4.12 - PRODUCTION READY (QA APPROVED)               |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "4.12"
#property description "v4.12 EA with Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.12_PRODUCTION"

input int MagicNumber = 400412;                       // EA magic number
input string TradeComment = "TP_Integrated 4_12";      // Trade comment
