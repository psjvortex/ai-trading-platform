//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_2_0_7.mq5        |
...
#property description "v4.2.0.7 EA with Complete Data Integrity + ConfluenceSlope + Spread + Entropy - ML-READY"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.2.0.7_COMPLETE"

input int MagicNumber = 4004208;                        // EA magic number
input string TradeComment = "TP_Integrated 4_2_0_7";      // Trade comment
