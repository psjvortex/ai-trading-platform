//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_9_6.mq5     |
...
#property description "v4.1.9.6 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.1.9.6_SLOPE_BT"

input int MagicNumber = 4004196;                        // EA magic number
input string TradeComment = "TP_Integrated 4_1_9_6";      // Trade comment
