//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_4_2_1_2.mq5        |
...
// #property description "v4.2.1.2 EA - Tighter Filters (Quality 90, Score 60, Full Confluence)"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.2.1.2_FIXED"

input int MagicNumber = 4004212;                        // EA magic number
input string TradeComment = "TP_Integrated 4_2_1_2";      // Trade comment
...
input int         StopLossPips_Indices    = 5000;             // SL Indices (pips) - 500 points (safer default)
input int         TakeProfitPips_Indices  = 5000;             // TP Indices (pips)
...
input double               MinQualityBuy              = 90.0;            // Min physics quality for BUY
input double               MinQualitySell             = 90.0;            // Min physics quality for SELL
...
input double               MinPhysicsScoreBuy         = 60.0;            // Min physics score for BUY
input double               MinPhysicsScoreSell        = 60.0;            // Min physics score for SELL
