...
#property description "Production EA integrating Physics, Risk, Tracker, and Logger - Timeframe tracking"
...
//+------------------------------------------------------------------+
//| Helper: Get current timeframe as string                          |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   // Include timeframe in filename for run separation
   ...
   Print("   Timeframe: ", timeframe, " (", EnumToString(ENUM_TIMEFRAMES(_Period)), ")");
   ...
   Print("   CSV Files:");
   Print("     - ", loggerConfig.tradeLogFile);
   Print("     - ", loggerConfig.signalLogFile);
   Print("═══════════════════════════════════════════════════════");
