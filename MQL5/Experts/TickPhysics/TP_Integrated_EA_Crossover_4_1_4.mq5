...
//+------------------------------------------------------------------+
//| Get Timeframe String for CSV Filenames                           |
//+------------------------------------------------------------------+
string GetTimeframeString()
{
   switch(Period())
   {
      ...
      default:         return StringFormat("M%d", PeriodSeconds(PERIOD_CURRENT)/60);
   }
}
...
int OnInit()
{
   ...
   loggerConfig.signalLogFile = "TP_Integrated_Signals_" + _Symbol + "_" + timeframeStr + "_v" + EA_VERSION + ".csv";
   loggerConfig.tradeLogFile = "TP_Integrated_Trades_" + _Symbol + "_" + timeframeStr + "_v" + EA_VERSION + ".csv";
