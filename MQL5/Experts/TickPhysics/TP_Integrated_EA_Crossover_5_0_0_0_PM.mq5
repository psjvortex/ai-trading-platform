//+------------------------------------------------------------------+
//|                    TP_Integrated_EA_Crossover_5_0_0_0_.mq5       |
...
input int MagicNumber = 5111;                        // EA magic number
input string TradeComment = "TP_Integrated 5_0_0_0_PM";      // Trade comment
...
input int         StopLossPips_Indices    = 200;             // SL Indices (pips) - 500 points (safer default)
input int         TakeProfitPips_Indices  = 200;             // TP Indices (pips)
input int         StopLossPips_Crypto     = 5000;              // SL Crypto (pips) - Safer default (~$50 on BTC)
input int         TakeProfitPips_Crypto   = 5000;              // TP Crypto (pips)
...
input double               MinQualityBuy              = 50.0;            // Min physics quality for BUY
input double               MinQualitySell             = 50.0;            // Min physics quality for SELL
...
input double               MaxSpreadPips              = 30.0;             // Max spread allowed (pips)
...
input double               MinPhysicsScoreBuy         = 20.0;            // Min physics score for BUY
input double               MinPhysicsScoreSell        = 20.0;            // Min physics score for SELL
...
void GetAssetAdaptiveSLTP(int &outStopLossPips, int &outTakeProfitPips)
{
   ...
   // int assetClass = (int)g_riskManager.GetAssetClass(); // Already defined above
