//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_1.mq5     |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v4.181 - OPTIMIZED THRESHOLDS (Phase 2)              |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "4.181"
#property description "v4.181 EA with Optimized Physics Thresholds from Phase 1 Analysis - PHASE 2 TEST"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.181_OPTIMIZED"

input int MagicNumber = 400418;                       // EA magic number
input string TradeComment = "TP_Integrated 4_181";      // Trade comment
...
input int         StopLossPips            = 2000;        // Stop loss (pips) - REALISTIC DEFAULT
input int         TakeProfitPips          = 1000;       // Take profit (pips) - 2:1 R:R
...
input group "⚡ Advanced Physics Entry Filters (OPTIMIZED v4.1.8.1)"
input bool                 UseAccelerationFilter      = true;            // Enable acceleration threshold
input double               MinAccelerationBuy         = 1170.7;          // Min acceleration for BUY (optimized from Phase 1)
input double               MinAccelerationSell        = -1534.1;         // Min acceleration for SELL (optimized from Phase 1)
input bool                 UseSpeedFilter             = true;            // Enable speed threshold
input double               MinSpeedBuy                = 4031.0;          // Min speed for BUY (optimized from Phase 1)
input double               MinSpeedSell               = -3797.0;         // Min speed for SELL (optimized from Phase 1)
input bool                 UseMomentumFilter          = true;            // Enable momentum threshold
input double               MinMomentumBuy             = 214.8;           // Min momentum for BUY (optimized from Phase 1)
input double               MinMomentumSell            = -215.5;          // Min momentum for SELL (optimized from Phase 1)
...
input double               MinPhysicsScore            = 40.0;            // Min physics score (Q3 threshold: 55-85 optimal)
