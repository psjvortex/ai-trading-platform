//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_4_1_8_4.mq5     |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v4.183 - SLOPE ANALYSIS (QA APPROVED)                |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "4.184"
#property description "v4.184 EA with Slope Analysis + Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "4.184_SLOPE"

input int MagicNumber = 4004184;                       // EA magic number
input string TradeComment = "TP_Integrated 4_184";      // Trade comment
...
input double               MinAccelerationBuy         = 14000.0;           // Min acceleration for BUY (positive)
input double               MinAccelerationSell        = -17000.0;          // Min acceleration for SELL (negative value)
input bool                 UseSpeedFilter             = true;           // Enable speed threshold
input double               MinSpeedBuy                = 27000.0;            // Min speed for BUY (positive)
input double               MinSpeedSell               = -24000.0;           // Min speed for SELL (negative value)
input bool                 UseMomentumFilter          = true;           // Enable momentum threshold
input double               MinMomentumBuy             = 1300.0;            // Min momentum for BUY (positive)
input double               MinMomentumSell            = -1100.0;           // Min momentum for SELL (negative value)
...
input double               MinPhysicsScore            = 96.0;            // Min physics score (Q3 threshold: 55-85 optimal)
...
input double               MinMomentumSlopeBuy        = 2.0;             // Min Momentum slope for BUY (positive, units/bar)
input double               MinMomentumSlopeSell       = -2.0;            // Min Momentum slope for SELL (negative, units/bar)
