//+------------------------------------------------------------------+
//|                         TP_Integrated_EA_Crossover_3_0_05M.mq5   |
...
#define EA_VERSION "3.0_05M"

input int MagicNumber = 300300;                // EA magic number
input string TradeComment = "TP_Integrated 3_0_05M";   // Trade comment
