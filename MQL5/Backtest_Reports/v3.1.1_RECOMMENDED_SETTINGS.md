...
| **MinQuality** | 70.0 | **90.0** | Quality ≥90 = 27.8% win rate |
...
## 📝 COMPLETE v3.1.1 INPUT PARAMETERS
...
// === Risk Management ===
input double      RiskPercentPerTrade     = 1.0;         // ⬇️ Reduced from 2.0
...
input bool                 UsePhysicsFiltersAsEntry   = true;            // Same ✅

// === Signal Filters ===
input bool                 UsePhysicsFilters          = true;            // Same
input double               MinQuality                 = 90.0;            // ⬆️ Increased from 70.0
input bool                 AvoidTransitionZone        = true;            // ⬆️ Changed from false
input bool                 UseRegimeFilter            = false;           // Same

// === Advanced Physics Entry Filters ===
input bool                 UseAccelerationFilter      = true;            // Same
input double               MinAccelerationBuy         = 1280.0;          // ⬆️ Increased from 100.0
input double               MinAccelerationSell        = 1280.0;          // ⬆️ Increased from 100.0
input bool                 UseSpeedFilter             = true;            // ⬆️ Changed from false
input double               MinSpeedBuy                = 3116.0;          // ⬆️ Increased from 55.0
input double               MinSpeedSell               = 3116.0;          // ⬆️ Increased from 55.0
input bool                 UseMomentumFilter          = true;            // ⬆️ Changed from false
input double               MinMomentumBuy             = 166.0;           // ⬆️ Increased from 40.0
input double               MinMomentumSell            = 166.0;           // ⬆️ Increased from 40.0
...
### Quality ≥ 90 Impact
- In v3.1.0, only 36 trades had Quality ≥ 90
...
- v3.1.0: MinAccel=100 → 741/742 trades passed (no filtering)
- v3.1.1: MinAccel=1280 → ~440 trades pass (40% rejection)
...
Copy to: `/Users/patjohnston/Desktop/MT5 Backtest CSV's/`
...
```cpp
MinQuality               = 95.0;      // ⬆️ From 90
MinAccelerationBuy       = 2000.0;    // ⬆️ From 1280
MinAccelerationSell      = 2000.0;    // ⬆️ From 1280
MinSpeedBuy              = 5000.0;    // ⬆️ From 3116
MinSpeedSell             = 5000.0;    // ⬆️ From 3116
```
