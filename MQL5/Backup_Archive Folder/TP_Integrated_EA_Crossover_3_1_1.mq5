//+------------------------------------------------------------------+
//|                       TP_Integrated_EA_Crossover_3_1_1.mq5       |
//|                      TickPhysics Institutional Framework (ITPF)  |
//|             v3.11 - PRODUCTION READY (QA APPROVED)               |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, QuanAlpha"
#property link      "https://github.com/quanalpha/tickphysics"
#property version   "3.11"
#property description "v3.11 EA with Universal Elite v3.1 Indicator Support - QA APPROVED"

// EA Version Info (for CSV tracking)
#define EA_NAME "TP_Integrated_EA"
#define EA_VERSION "3.11_PRODUCTION"

input int MagicNumber = 300311;                       // EA magic number
input string TradeComment = "TP_Integrated 3_11";      // Trade comment
...
input double               MinAccelerationBuy         = 1280.0;           // Min acceleration for BUY (positive)
input double               MinAccelerationSell        = 1280.0;           // Min acceleration for SELL (absolute value)
input bool                 UseSpeedFilter             = true;           // Enable speed threshold
input double               MinSpeedBuy                = 3116.0;            // Min speed for BUY (positive)
input double               MinSpeedSell               = 3116.0;            // Min speed for SELL (absolute value)
input bool                 UseMomentumFilter          = true;           // Enable momentum threshold
input double               MinMomentumBuy             = 166.0;            // Min momentum for BUY (positive)
input double               MinMomentumSell            = 166.0;            // Min momentum for SELL (absolute value)
